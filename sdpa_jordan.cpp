...
qd_real Jal::trace(DenseLinearSpace& aMat)
{
  qd_real ret = 0.0;

  for (int l=0; l<aMat.SDP_nBlock; ++l) {
    qd_real* target = aMat.SDP_block[l].de_ele;
...
qd_real Jal::getMinEigen(DenseLinearSpace& lMat,
...
qd_real Jal::getMinEigen(DenseLinearSpace& xMat,
                        WorkVariables& work)
{
  qd_real min = 1.0E50;
  qd_real value;
