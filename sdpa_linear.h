...
// by Lanczos metnod
  static qd_real getMinEigen(DenseMatrix& lMat, DenseMatrix& xMat,
			    DenseMatrix& Q,
...
// caluculate all eigenvalues of aMat  by QR method 
  static qd_real getMinEigenValue(DenseMatrix& aMat,
				 Vector& eigenVec,
				 Vector& workVec);

  static bool getInnerProduct(qd_real& ret,
...
// nakata 2004/12/01 
  ...
  static bool multiply(DenseMatrix& retMat,
		       ...
		       qd_real* scalar = NULL);
  static bool multiply(DenseMatrix& retMat,
		       DenseMatrix& aMat, qd_real* scalar = NULL);
  static bool multiply(Vector& retVec,
		       Vector& aVec, qd_real* scalar = NULL);
  ...
  static bool plus(Vector& retVec, Vector& aVec,
		   Vector& bVec, qd_real* scalar = NULL);
  ...
  static bool plus(BlockVector& retVec,
		   BlockVector& aVec,
		   BlockVector& bVec, qd_real* scalar = NULL);
  ...
  static bool let(DenseMatrix& retMat, const char eq,
		  DenseMatrix& aMat, const char op,
		  DenseMatrix& bMat, qd_real* scalar = NULL);
  ...
  static bool let(DenseMatrix& retMat, const char eq,
		  DenseMatrix& aMat, const char op,
		  SparseMatrix& bMat, qd_real* scalar = NULL);
  ...
  static bool let(qd_real& ret, const char eq,
		  Vector& aVec, const char op,
		  Vector& bVec);
...
// CAUTION!!! We don't initialize retMat to zero matrix for efficiently.
  ...
  static bool let(DenseLinearSpace& retMat, const char eq,
		  DenseLinearSpace& aMat, const char op,
		  DenseLinearSpace& bMat, qd_real* scalar = NULL);
  ...
  static bool let(DenseLinearSpace& retMat, const char eq,
		  DenseLinearSpace& aMat, const char op,
		  SparseLinearSpace& bMat, qd_real* scalar = NULL);
